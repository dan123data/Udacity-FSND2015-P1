...
iron_man = media.Movie('Iron Man',
					...
					overseas, but terrorists kidnap him to force him to build a 
					devastating weapon. Instead, he builds an armored suit and 
					upends his captors. Returning to America, Stark refines the 
...
back_to_the_future = media.Movie('Back to the Future',
						'''A teenager (Michael J. Foxx) time travels to the past
						 and gets hit on by his mom.''',
...
tron_legacy = media.Movie('Tron: Legacy',
					'''Years after Sam Flynn\'s father disappeared into the 
					machine, Sam follows in his foot steps.''',
...
space_camp = media.Movie('Space Camp',
					'''A group of kids get more than they could imagine when 
					they attend space camp.''',
...
iron_eagle = media.Movie('Iron Eagle',
					'''A high school student teams with a Air Force pilot to 
					rescue his father.''',
					'https://upload.wikimedia.org/wikipedia/en/0/04/Iron_eagle.jpg',
					'https://www.youtube.com/watch?v=3npr0RKBucc')

# List of movies to display on page in alphabetical order.
movies = [back_to_the_future, iron_eagle, iron_man, space_camp, tron, tron_legacy]
