...
back_to_the_future = media.Movie('Back to the Future',
                                 'A teenager (Michael J. Foxx) time travels to the past and gets hit on by his mom.',
...
tron = media.Movie('Tron',
                   'Kevin Flynn, computer programmer, finds a way into the machine and has to battle his way out.',
...
tron_legacy = media.Movie('Tron: Legacy',
                          'Years after Sam Flynn\'s father disappeared into the machine, Sam follows in his foot steps.',
...
space_camp = media.Movie('Space Camp',
                         'A group of kids get more than they could imagine when they attend space camp.',
...
iron_eagle = media.Movie('Iron Eagle',
                         'A high school student teams with a Air Force pilot to rescue his father.',
